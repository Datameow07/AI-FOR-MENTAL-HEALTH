...
# Load the dataset
data = pd.read_csv("/Users/arbiazabi/WEB DEVELOPMENT 5TH SEM/react-cycle1/frontend mental/Psykh-A-Mental-Health-Chatbot/frontend mental 2/MindEase/database/Gen_db.csv")
